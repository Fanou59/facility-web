    ...
    <PageContainer>
      <Section title="Mentions légales">
        ...
        <p>
          ...
          <a href="https://www.facility-web.fr">https://www.facility-web.fr</a>{" "}
        ...
        <p>
          <strong>Propriétaire</strong> : EI Facility-Web Capital social de 0€
          Numéro de TVA: N/A – 180 route de cobrieux 59242 Genech
        </p>
        <p>
          {" "}
          <strong>Responsable publication</strong> : Guery Stéphane –
          stephane@facility-web.fr
          <br />
          Le responsable publication est une personne physique ou une personne
          morale.
          <br />
          <strong>Webmaster</strong> : Guery Stéphane – stephane@facility-web.fr
          <br />
          <strong>Hébergeur</strong> : OVH – 2 rue Kellermann 59100 Roubaix
          ovh.com
          <br />
          <strong>Délégué à la protection des données</strong> : Guery Stéphane
          – stephane@facility-web.fr
        </p>
        <div>
          <p>
            ...
            créé par{" "}
            <a href="https://evico.fr/" title="Agence web Evico">
              l’agence web Evico
            </a>
          </p>
        </div>
        ...
        <p>
          ...
          <br />
          Le site web{" "}
          <a href="https://www.facility-web.fr">
        ...
        <p>
          ...
          Facility-Web.{" "}
          <a href="https://www.facility-web.fr">https://www.facility-web.fr</a>
          est représenté par Guery Stéphane, son représentant légal
        </p>
        <p>
        ...
        <p>
          {" "}
          Facility-Web – DPO, Guery Stéphane <br />
