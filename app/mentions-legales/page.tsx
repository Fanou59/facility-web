    ...
    <PageContainer>
      <Section title="Mentions légales">
        <div className="space-y-6">
          <h2 className="text-2xl font-bold mt-8 mb-4">Définitions</h2>
          <div className="space-y-4">
            <p>
              <span className="font-semibold">Client :</span> tout professionnel
              ou personne physique capable au sens des articles 1123 et suivants
              du Code civil, ou personne morale, qui visite le Site objet des
            ...
            <p>
              <span className="font-semibold">Contenu :</span> Ensemble des
              éléments constituants l'information présente sur le Site,
              notamment textes – images – vidéos.
            </p>
            <p>
              <span className="font-semibold">Informations clients :</span> Ci
            ...
            <p>
              <span className="font-semibold">Utilisateur :</span> Internaute se
          ...
          <p>
            Le site utilise la technologie{" "}
          ...
          <p>
            ...
            communication marketing, la{" "}
            <span className="font-semibold">
              loi du 21 Juin 2014 pour la confiance dans l'Economie Numérique
            </span>
            , la{" "}
            <span className="font-semibold">
              Loi Informatique et Liberté du 06 Août 2004
            </span>{" "}
            ainsi que du{" "}
            <span className="font-semibold">
              Règlement Général sur la Protection des Données (RGPD : n°
          ...
          <ul className="list-disc ml-6 space-y-2">
            <li>
              droit d'accès (
              <span className="font-semibold">article 15 RGPD</span>) et de
              rectification (
              <span className="font-semibold">article 16 RGPD</span>), de mise à
              jour, de complétude des données des Utilisateurs droit de
              verrouillage ou d'effacement des données des Utilisateurs à
              caractère personnel (
              <span className="font-semibold">article 17 du RGPD</span>),
            ...
            <li>
              ...
              <span className="font-semibold">article 13-2c RGPD</span>)
            </li>
            <li>
              droit à la limitation du traitement des données des Utilisateurs (
              <span className="font-semibold">article 18 RGPD</span>)
            </li>
            <li>
              droit d'opposition au traitement des données des Utilisateurs (
              <span className="font-semibold">article 21 RGPD</span>)
            </li>
            <li>
              ...
              <span className="font-semibold">article 20 RGPD</span>)
            </li>
            <li>
          ...
          <p>
            ...
            période maximale de{" "}
            <span className="font-semibold">
              9 mois après la fin de la relation contractuelle
            </span>{" "}
            :
          </p>
          ...
          <p>
            Ces données sont conservées pour une période maximale de{" "}
            <span className="font-semibold">
              9 mois après la fin de la relation contractuelle
            </span>
            .
          ...
          <p>
            ...
            pleinement nos clients de toutes les questions relevant de la
          ...
          <p>
            ...
            <span className="font-semibold">Lille</span>.
          </p>
        </div>
      </Section>
    </PageContainer>
